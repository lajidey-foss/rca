...
def get_gl_entries(filters, accounting_dimensions):
	...
	gl_entries = frappe.db.sql(
		...
		select
			...
			WHEN voucher_type ='Payment Entry' THEN (SELECT entry_type FROM `tabPayment Entry` WHERE name=voucher_no ) ELSE 'MAIN VCH' END AS entry_type, 
			{dimension_fields} cost_center, project,
...
def get_conditions(filters):
	...
	if filters.get("bill_type"):
		conditions.append("entry_type=%(bill_type)s")
